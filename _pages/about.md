...
액체추진및진단연구실(Liquid Propulsion and Optical Diagnostics Lab.)은 다양한 **첨단 레이저 진단기법**을 이용하여 **액체추진시스템의 성능 개선**연구를 수행합니다. 스크램젯, 항공용 가스터빈, 액체로켓 엔진의 분무 형성·미립화·혼합 과정을 계측하고, 이를 인젝터 설계 개선으로 연결하는 것이 연구실의 목표입니다.

- 다양한 환경에서의 분무 구조 가시화 (PLIF, Mie scattering, shadowgraphy)
